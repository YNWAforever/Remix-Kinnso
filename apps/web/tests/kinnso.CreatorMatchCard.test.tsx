...
describe('CreatorMatchCard', () => {
  it('renders the computed match score', () => {
    ...
    render(<CreatorMatchCard creator={creator} saved={false} onToggleSave={vi.fn()} onQuickView={vi.fn()} />)
  ...
  it('fires onToggleSave and onQuickView', () => {
    ...
    render(<CreatorMatchCard creator={creator} saved={false} onToggleSave={onToggleSave} onQuickView={onQuickView} />)
