...
describe('ExploreView', () => {
  it('renders the explore heading and a card per mock guide', () => {
    ...
    // each guide links to its localized detail route
    expect(screen.getAllByRole('link').some((a) => a.getAttribute('href') === `/en/g/${guides[0].slug}`)).toBe(true)
  })
})
