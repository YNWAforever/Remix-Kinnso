...
export const EarningsTicker: React.FC<{ items?: TickerItem[] }> = ({ items: seed = tickerSeed }) => {
  ...
  return (
    <div className="relative overflow-hidden bg-kinnso-ink py-3 text-white">
      <div className="flex animate-marquee whitespace-nowrap">
        {items.map((it, i) => (
          <span key={i} className="mx-6 inline-flex items-center gap-2 text-sm">
            ...
            <span className="k-mono font-bold text-kinnso-green">+HK${it.amount.toLocaleString()}</span>
