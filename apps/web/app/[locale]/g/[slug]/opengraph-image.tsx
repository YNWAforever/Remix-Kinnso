...
import { truncate, safeImageUrl } from '@/lib/seo/og/data'
...
export default async function Image({ params }: { params: Promise<{ locale: string; slug: string }> }) {
  ...
  const card = guide
    ? <GuideCard title={truncate(guide.title, 70)} city={guide.city} handle={guide.creatorHandle} cover={safeImageUrl(guide.cover)} />
